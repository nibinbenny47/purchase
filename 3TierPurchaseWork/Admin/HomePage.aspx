        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
					...
					<%--purchase details link button--%>
                <li class="sub-menu">
                    <a href="PurchaseWholesale.aspx">
					<%--<asp:LinkButton runat="server" ID="lkbtnPurchaseWholeSale" CommandName="PurchaseWholesale">Purchase Details </asp:LinkButton>--%>
                        <i class="fa fa-book"></i>
                        <span>Purchase Details </span>
                    </a>
                    <ul class="sub">
						<li><a href="PurchaseWholesale.aspx">Purchase</a></li>
